...
- (void)loadDataFromNetwork {
	...
	// 评论内容数据（随机出现）
	if (arc4random() % 2 == 0) {
		commentArray = @[@"评论内容1", @"评论内容2", @"2016年6月，苹果系统iOS 10正式亮相，苹果为iOS 10带来了十大项更新。2016年6月13日，苹果开发者大会WWDC在旧金山召开，会议宣布iOS 10的测试版在2016年夏天推出了，正式版将在秋季发布。2016年9月7日，苹果发布iOS 10。iOS10正式版于9月13日(北京时间9月14日凌晨一点)全面推送。", @"评论内容4"];
	}
	// 评论头
